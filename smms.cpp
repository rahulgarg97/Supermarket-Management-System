...
pos=search(id); // for check weather desire node
is exist or not
if(pos<=count){
while(cur->ID!=id){ // for delete middle area
...
while(p!=NULL)
{
myfile<<p->ID<<"\t\t"<<p->proName<<"\t\t\t\t"<<p-

>prePrice<<"\t\t\t"<<check(p->quantity)<<"\n";
...
cout<<p->ID<<"\t\t"<<p->proName<<"\t\t\t\t"<<p-

>prePrice<<"\t\t"<<check(p->quantity)<<"\n"; // call check func and pass
quantity
...
cin>>no;
int count=display(); // for store no of nodes in

c

while (i<=no){
struct node *cur=head;
int quant,cho; // quant for quantity and cho for
...
B2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\
xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2
\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB
2\xB2\xB2\n\n";
cout<<"<<<<<<<<<<<<<<<<<<<<<<<< SuperMarket >>>>>>>>>>>>>>>>>>>>\n";
// \xB2 is for styling
cout<<"<<<<<<<<<<<<<<<<<<<<<<<< Store >>>>>>>>>>>>>>>>>>>>\n";
...
\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB
2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\x
B2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\
xB2\n\n"; // on console
...
switch(ch){
case 1:
if (temp==0){ // Second time and on ward this is only
executed
end();
}
